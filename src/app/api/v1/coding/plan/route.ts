...
const plans: PlanData[] = [
    ...
    tasks: [
      {
        id: "t1",
        title: "数据层",
        description: "Order 表结构变更，新增 payment_channel、refund_reason 列，编写迁移脚本与回滚脚本",
        estimatedHours: 8,
        children: [
          { id: "t1.1", title: "迁移脚本", description: "编写 up/down migration SQL", estimatedHours: 3 },
          { id: "t1.2", title: "Model 层适配", description: "更新 Order model 字段映射与类型定义", estimatedHours: 3 },
          { id: "t1.3", title: "数据校验", description: "添加字段级校验逻辑与单元测试", estimatedHours: 2 },
        ],
      },
      {
        id: "t2",
        ...
        estimatedHours: 10,
        children: [
          { id: "t2.1", title: "Refund 端点", description: "实现退款接口，含幂等键与状态机校验", estimatedHours: 5 },
          { id: "t2.2", title: "筛选扩展", description: "GET /api/orders 增加 channel、status 筛选", estimatedHours: 3 },
          { id: "t2.3", title: "错误处理", description: "统一错误码与国际化错误消息", estimatedHours: 2 },
        ],
      },
      {
        id: "t3",
        ...
        estimatedHours: 12,
        children: [
          { id: "t3.1", title: "退款 UI", description: "退款按钮、金额输入、二次确认弹窗", estimatedHours: 5 },
          { id: "t3.2", title: "列表增强", description: "渠道列、筛选下拉、批量操作", estimatedHours: 4 },
          { id: "t3.3", title: "状态同步", description: "WebSocket 实时更新订单状态", estimatedHours: 3 },
        ],
      },
    ],
    apis: [
    ...
    tasks: [
      {
        ...
        estimatedHours: 6,
        children: [
          { id: "t1.1", title: "密钥管理", description: "RSA 密钥对生成与安全存储", estimatedHours: 2 },
          { id: "t1.2", title: "签发逻辑", description: "access + refresh token 签发实现", estimatedHours: 4 },
        ],
      },
      {
        id: "t2",
        ...
        estimatedHours: 8,
        children: [
          { id: "t2.1", title: "验证中间件", description: "JWT 签名验证 + 黑名单检查", estimatedHours: 4 },
          { id: "t2.2", title: "刷新端点", description: "POST /auth/refresh 端点实现", estimatedHours: 4 },
        ],
      },
    ],
    apis: [
  ...
  },
  {
    ...
    tasks: [
      {
        ...
        estimatedHours: 6,
        children: [
          { id: "t1.1", title: "MQ 集成", description: "接入 RabbitMQ 投递导出任务", estimatedHours: 3 },
          { id: "t1.2", title: "Worker 实现", description: "消费任务，生成文件存 MinIO", estimatedHours: 3 },
        ],
      },
    ],
    apis: [
    ...
    dependencies: [
      { from: "t1.1", to: "t1.2", label: "Worker 消费 MQ" },
    ],
    workload: {
      totalPersonHours: 6,
      storyPoints: 3,
