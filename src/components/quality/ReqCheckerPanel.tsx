...
import type { CheckerItemStatus, ReqCheckerItem, ReqCheckerResponse } from "@/types/factory";

const fetcher = (url: string): Promise<ReqCheckerResponse> => fetch(url).then((res) => res.json());
