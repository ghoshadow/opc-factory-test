...
import { ArrowRight, CheckCircle2, Loader2, Circle, XCircle } from "lucide-react"
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  node.status === "running" && "border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/20",
                  node.status === "done" && "border-emerald-200 bg-emerald-50/50 dark:border-emerald-800 dark:bg-emerald-950/20",
                  node.status === "failed" && "border-red-200 bg-red-50/50 dark:border-red-800 dark:bg-red-950/20",
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={cn(
                    ...
                    node.status === "done" && "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400",
                    node.status === "running" && "bg-blue-100 text-blue-700 dark:bg-blue-950/40 dark:text-blue-400",
                    node.status === "failed" && "bg-red-100 text-red-700 dark:bg-red-950/40 dark:text-red-400",
                    node.status === "waiting" && "bg-gray-100 text-gray-500 dark:bg-gray-900/40 dark:text-gray-500",
                  )}>
                    {statusLabelMap[node.status]}
                  </span>
                </div>
