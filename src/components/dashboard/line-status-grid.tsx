...
import { DashboardLineStatusData, DashboardLineStatus } from "@/lib/types";
...
interface LineStatusGridProps {
  data: DashboardLineStatusData[];
}

const lineIcons: Record<DashboardLineStatusData["line"], typeof GitBranch> = {
