...
// Test scenario types (for testing/cases API)
export type TestStepStatus = "pending" | "passed" | "failed" | "running";
...
// Test execute types (for testing/execute API)
...
export type RollbackResult = "success" | "failed";
